...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://545ettmbd3.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.postresumeFolderFilePut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['file', 'folder', 'body'], ['body']);
    ...
    apigClient.postresumeFolderFileOptions = function (params, body, additionalParams) {
        ...
        var postresumeFolderFileOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/postresume/{folder}/{file}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
